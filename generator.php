...
<body class="text-white">
    ...
    <div class="absolute top-20 left-4 w-64 p-4 rounded-xl ui-panel border border-gray-700 shadow-xl space-y-6">
        ...
        <div class="pt-4 border-t border-gray-700">
            <button onclick="window.saveImage()"
                class="w-full bg-green-600 hover:bg-green-500 text-white font-bold py-2 rounded-lg transition-all shadow-lg flex items-center justify-center gap-2">
